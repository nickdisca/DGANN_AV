function [Q_save,ind_save,ptc_hist,t_hist,Save_times] = Euler2D(Q,gas_gamma,gas_const,Save_soln)
...
while (time<FinalTime)
    ...
    % SSP-RK3 Stage 2
    rhsQ = EulerRHS2D(Q1, time, gas_gamma, gas_const);
    Q2   = (3*Q + Q1 + dt*rhsQ)/4;
    ...
    % SSP-RK3 Stage 3
    rhsQ = EulerRHS2D(Q2, time, gas_gamma, gas_const);
